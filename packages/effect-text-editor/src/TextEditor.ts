import type { IEventListenerId, IText } from '@leafer-in/interface'
...
export class TextEditor extends InnerEditor {
  ...
  public onLoad(): void {
    ...
    this.isHTMLText = text.tag === 'HTMLText'
    ...
    this.isHTMLText ? div.innerHTML = String(text.text) : div.textContent = String(text.text)
  ...
  protected onInput(): void {
    const { editDom } = this
    this.editTarget.text = this.isHTMLText ? editDom.innerHTML : editDom.textContent
  }
